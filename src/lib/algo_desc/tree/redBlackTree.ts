...
const root = [1, 2, 3, 4, 5, 6]; root.val = 1; root.left = [2, 3, 4]; root.right = [5, 6];
const two = root.left; two.val = 2; two.left = [3]; two.right = [4];
const three = two.left; three.val = 3; three.left = null; three.right = null;
const four = two.right; four.val = 4; four.left = null; four.right = null;
const five = root.right; five.val = 5; five.left = [6]; five.right = null;
const six = five.left; six.val = 6; six.left = null; six.right = null;
...
const root = new SenkiLinkedNode(1);
const two = new SenkiLinkedNode(2);
const three = new SenkiLinkedNode(3);
const four = new SenkiLinkedNode(4);
const five = new SenkiLinkedNode(5);
const six = new SenkiLinkedNode(6);
root.left = two;
root.right = five;
two.left = three;
two.right = four;
